    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <tbody>
              <tr class="success">
                <div class="radio">
                  <td width="200px"><label><input type="radio" name="optradio" value="cash" checked>Cash</label></td>
                  <td width="200px"><label><input type="radio" name="optradio" value="saldo" >Saldo Docotin</label></td>
                </div>
              </tr>
            </tbody>
          </table>
          <div class="radio-saldo">          
            ...
            <div class="modal-footer">
              <a href="/pembeli/pemesanan/list-pemesanan"><button type="button" class="btn btn-primary">Lanjutkan</button></a> 
        ...
        <div class="col-md-7">
          <div>
            <div class="row gap-bottom1">
              ...
              <br><br>
              <div class="col-md-3">
                <a href="/pembeli/pemesanan/ubah-detail-data"><button type="button" class="btn btn-primary">Ubah</button></a>
              </div>
