    ...
    <div class="col-md-8 col-md-offset-2">
      ...
      <br/> 
          ...
          <tr>
              ...
              <button name="btn_tambah" class="btn btn-primary" style="text-align: left;">Tambah Data</button>
              <button name="btn_tambah" class="btn btn-danger" style="text-align: left;">Cancel</button>
              </td>
              </div>
          </tr>
      </table>
